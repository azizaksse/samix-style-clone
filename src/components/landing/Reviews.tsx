...
const REVIEWS = [
  { name: "أحمد م.", text: "نتيجة رائعة بعد شهر فقط من الاستعمال، الشعر الزائد قل بشكل ملحوظ.", rating: 5 },
  { name: "ياسين ب.", text: "منتج ممتاز و التوصيل كان سريع، أنصح به بشدة كبديل آمن لليزر.", rating: 5 },
  { name: "كريم ز.", text: "جربت طرق كثيرة و هذه الأفضل، بشرة ناعمة بدون ألم.", rating: 5 },
