...
const QUESTIONS = [
  {
    q: "كيف يستخدم زيت Rova؟",
    a: "بعد إزالة الشعر من الجذور (بالحلاوة أو الشمع)، تدهن المنطقة بزيت Rova مع تدليك خفيف. يكرر ذلك يومياً لمدة 4 أيام بعد كل عملية إزالة للشعر.",
  },
  {
    q: "متى تظهر النتائج؟",
    a: "يبدأ الشعر بالظهور بشكل أبطأ وأخف بعد الجلسات الأولى، و ينعدم تماما بعد 3 إلى 4 أشهر من الاستعمال المنتظم.",
  },
  {
    q: "هل له آثار جانبية؟",
    a: "Rova مكون من زيوت طبيعية 100%، و لا يسبب أي آثار جانبية. ينصح بتجربته على مساحة صغيرة من الجلد أولا في حال وجود حساسية.",
  },
  {
